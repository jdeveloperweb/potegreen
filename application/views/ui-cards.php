                    ...
                    <div class="col-lg-4 ">
                        <div class="card">
                            <div class="card-body text-center">
                                <h4 class="card-title">2 Special title treatment</h4>
                                <p class="card-text">With supporting text below as a natural lead-in to additional
                                    content.
                                </p>
                                <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light w-100">Go somewhere</a>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body text-end">
                                <h4 class="card-title">3 Special title treatment</h4>
                                <p class="card-text">With supporting text below as a natural lead-in to additional
                                    content.
                                </p>
                                <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light w-100">Go somewhere</a>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="card p-3 text-end">
                                    <blockquote class="blockquote blockquote-reverse font-size-16 mb-0">
                                        <p>AQUI Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                            erat
                                            a ante.</p>
