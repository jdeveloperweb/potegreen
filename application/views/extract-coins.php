                  ...
                  <div class="col-md-12 col-xl-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="card">
                                      <div class="card-body">
                                <h5 class="card-title ">Extrato de moedas</h5>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: auto;">Detalhamento</th>
                                                <th>Crédito</th>
                                                <th>Débito</th>
                                                <th>Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>07/08/2022</td>
                                                <td>Transferência enviada para Rafael</td>
                                                <td>-</td>
                                                <td>25000</td>
                                                <td>Processado</td>
                                            </tr>
                                            <tr>
                                                <td>07/08/2022</td>
                                                <td>Transferência recebida de Rafael</td>
                                                <td>-</td>
                                                <td>20000</td>
                                                <td>Processado</td>
                                            </tr>
                                            <tr>
                                                <td>07/08/2022</td>
                                                <td>Prêmio 2º Colocado no Ranking</td>
                                                <td>35050</td>
                                                <td>-</td>
                                                <td>Processado</td>
                                            </tr>
                                            <tr>
                                                <td>07/08/2022</td>
                                                <td>Prêmio 1º Colocado no Ranking</td>
                                                <td>80000</td>
                                                <td>-</td>
                                                <td>Processado</td>
                                            </tr>
                                            <tr>
                                                <td>07/08/2022</td>
                                                <td>Crédito de pacote adquirido</td>
                                                <td>250</td>
                                                <td>-</td>
                                                <td>Processado</td>
                                            </tr>
