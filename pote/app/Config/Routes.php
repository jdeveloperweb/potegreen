...
// Financial
$routes->get('financial-buy-coins', 'Home::show_financial_buy_coins');
$routes->get('financial-transfer-coins', 'Home::show_financial_transfer_coins');
$routes->get('financial-withdraw', 'Home::show_financial_withdraw');
$routes->get('financial-rates', 'Home::show_financial_rates');

// Extract
$routes->get('extract-purchases', 'Home::show_extract_purchases');
$routes->get('extract-coins', 'Home::show_extract_coins');
$routes->get('extract-transfers', 'Home::show_extract_transfers');
...
$routes->get('how-it-works', 'Home::show_how_it_works');
$routes->get('my-profile', 'Home::show_my_profile');
$routes->get('my-reviews', 'Home::show_my_reviews');
$routes->get('my-ranking', 'Home::show_my_ranking');
