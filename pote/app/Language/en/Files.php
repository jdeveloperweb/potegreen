...
return [
  ...
  "View_more" => "View more",
  "Buy_more" => "Buy More",
  "Transations_coins" => "Coins Transations",
  "Apps" => "Apps",
  ...
  "Is_website_right" => " Is the site's tip accurate?",
  "Last_Ranking" => "Last Ranking",
  "Lasts_results" => "Lasts Resutls",
  "Event" => "Event",
  "Website_opinion" => "Website Tip",
  "Suport" => "Suport",
  "Yes" => "Yes",
  "No" => "No",
  "Pot_of_Coins"=>"Pot of Coins",
