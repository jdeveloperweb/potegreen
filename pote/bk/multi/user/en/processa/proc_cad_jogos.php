...
include_once("../conexao.php");
 ...
 { $newodd[$i]=$odd[$i]*100;
  ...
  {
   mysqli_query($conectar,"INSERT INTO jogosug (data, hora, timea, timeb, link, resultado, investimento, oddini, status) values ('$dia','$timep[$i]', '$timea[$i]','$timeb[$i]','$link[$i]','$resultado[$i]',1,'$newodd[$i]','$status')");	 
  }
 }
