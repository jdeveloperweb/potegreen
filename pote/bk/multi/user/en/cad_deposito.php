                     ...
                     <div class="page-content-wrapper">
                        ...
                        <div class="container-fluid">
							...
							<div class="form-group">
										<label>Ajustar banca - Depósitos</label>
													<p class="text-muted m-b-30 font-14"> Vai acrescentar algum valor à sua banca? Aqui é o local para isso.  Cadastre quanto vai adiconar e iremos atualizar seu saldo atual.  </br></br>Caso queira registrar um saque realizado, clique aqui. </br></br><strong>ATENÇÃO! ESTA OPERAÇÃO PODERÁ SER DESFEITA. </br>Não há nenhuma movimentação de dinheiro por aqui e sim uma forma de você gerenciar sua banca, controlando melhor seus lucros e perdas. </strong></br> </p>
										<div>
											<label for="example-email-input" class="col-sm-4 col-form-label">Valor do depósito</label>
											...
											<div class="input-group col-lg-4">
												 <p class= "text-align-center"><input type="hidden"   name="dep" id="dep" value="1" /></p>
											</div>
											<button type="submit" class="btn btn-success">Cadastrar Depósito</button>
												</div>
											</div><!-- input-group -->
										</div>
