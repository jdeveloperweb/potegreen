            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-muted text-center">Login to <br><strong> MultiplaGreen Dashboard</strong><p>
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-sm-6">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customControlInline">Remind me</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 text-right">
                                    <button class="btn btn-success w-md waves-effect waves-light" type="submit">Login</button>
                                </div>
                            </div>

                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-12 m-t-20">
                                    <a href="https://wa.me/5553999466200" class="text-muted"><i class="mdi mdi-lock"></i> Did you forgot your password? Talk to the attendant.</a>
                                </div>
                            </div>
                        </form>
