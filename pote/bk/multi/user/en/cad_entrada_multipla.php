...
$result=mysql_query("SELECT * FROM multiplassug WHERE id = '$id'");
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="card m-b-20">
							<div class="card-body">
							 <form class="form-horizontal" method="POST" action="processa/proc_cad_entrada_multipla.php">	
							<div class="form-group">
										<label>CADASTRAR ENTRADA EM MÚLTIPLA</label>
										...
										<div><label for="example-email-input" class="col-sm-2 col-form-label"> Entrada na multipla:</label>
												<hr>
											<h6><span><strong><i class="mdi mdi-clock  "> </i>Dia</strong></br> <?php echo  $resultado['data'] ?></span></h6>
											<h6><span><strong><i class="mdi mdi-soccer  "></i>Jogos</strong></br>  <?php echo  mb_strtoupper($resultado['descricao'], $encoding);?> </span></h6>
											<h6><span><strong><i class="fa fa-percent   "></i>Odd</strong></br> <?php echo  mb_strtoupper($resultado['oddtotal']/100, $encoding);?></span></h6>
											<h6><span><strong><i class="fa fa-money   "> </i>Entrada Sugerida</strong></br>R$ <?php echo number_format($_SESSION['bancaAtual']/100/200,2,",","."); ?> - (Entrada Sugerida)</h6></span> 
											<hr>
											...
											<input class="input-group " id="descricao" name="descricao" type="hidden" value="<?php echo $resultado['descricao']; ?>" />
											<input class="input-group " id="data" name="data" type="hidden" value="<?php echo $resultado['data']; ?>" />
											<input class="input-group " id="oddini" name="oddini" type="hidden" value="<?php echo $resultado['oddtotal']; ?>" />
											<input class="input-group " id="tipo" name="tipo" type="hidden" value="<?php echo $resultado['tipo']; ?>" />										
											<input class="input-group " id="status" name="status" type="hidden" value="<?php echo $resultado['status']; ?>" />
												...
												<div class="input-group col-lg-4">
												 <p class= "text-align-center"><input type="number"  step="0.01"  min="1.00"class="form-control" maxlength="25" name="oddent"  placeholder="<?php echo $resultado['oddtotal']/100; ?>" id="oddent"  required /></p>
