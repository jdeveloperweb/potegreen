    ...
    <nav class="navbar-custom">
        ...
        <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item dropdown notification-list">
                <a class="nav-link waves-effect toggle-search" href="https://multiplagreen.com/user/administrador.php?link=1"> Voltar ao painel
            ...
            <li class="list-inline-item dropdown notification-list hidden-xs-down">
                ...
                <div class="dropdown-menu dropdown-menu-right language-switch">
                    <a class="dropdown-item" href="en/administrador.php?link=1"><img src="public/assets/images/flags/us_flag.jpg" alt="" height="16" /><span> English </span></a>
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a class="dropdown-item" data-toggle="modal" data-target="#myModal"><i class="dripicons-user text-muted"></i> Editar foto</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myModalLabel">Alterar Foto</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="card-body">

                        <p class="text-muted m-b-30 font-14">Escolha um novo avatar para o seu perfil.</p>
		  ...
		  <input type="hidden" name="id" value="<?php echo $id_produto;?>">
                        ...
                        <form action="processa/proc_edit_avatar.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="file" name="arquivo" class="filestyle" data-buttonText="Procurar" data-buttonname="btn-secondary">
                            </div>
