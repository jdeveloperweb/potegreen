                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body"></br></br>
                                            ...
                                            </br>Para ver a situação em determinado período, selecione a data de início e de fim desejados:</br></br>
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <div class="input-group col-lg-5">
                                                            ...
                                                            <label for="example-date-input" class="col-sm-3 col-form-label">Início:</label><input type="date" class="form-control" name="nini">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <div class="input-group col-lg-5">
                                                            ...
                                                            <label for="example-date-input" class="col-sm-3 col-form-label">Fim:</label><input type="date" class="form-control" name="nfim">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                            </div>
                                                        </div><!-- input-group -->
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div>
                                                        <div class="form-group col-lg-5">
                                                            <p class="text-align-center"> <button type="submit" class="btn-block btn-primary">Buscar</button></br></p>
