...
mysqli_query($conectar, "INSERT INTO entradas (id_user, data, tipo, descr, oddini, oddent, valor_ent, status, valor_fim, id_jogsug) values ('$id_user', '$data', 'Múltipla', '$descr', '$oddini', '$oddent', '$valor_ent', '$status', '$valor_fim', '$id_jogsug')");	 
