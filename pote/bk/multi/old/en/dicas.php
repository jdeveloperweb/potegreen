...
if(($_SESSION['usuarioId'] == "") || ($_SESSION['usuarioNivelAcesso'] != "Ativo") || ($_SESSION['usuarioSenha'] == "")){
	...
	//Mensagem de Erro
	$_SESSION['loginErro'] = "You don't have an active plan yet. If you have already done so, wait for confirmation by Eduzz. Thanks! ";
...
<section class="engine"><a href="https://mobirise.info/e">make your own site</a></section><section class="mbr-section content4 cid-s99LNrJNVL" id="content4-c">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-2"><strong>Tips</strong></h3>
					...
					<div class="row main justify-content-center">
						<div class="media-container-column col-12 col-lg-3 col-md-4">
							<div class="mbr-section-btn align-left py-4"><a class="btn btn-danger display-5" href="">
								 ...
								 <?php echo date('M-d', strtotime($linhas['dia'])); ?></a></div>
						</div>
						...
						<?php
							...
							echo "<div class='row main justify-content-center'><p class='text-center text-danger'>Subscribe to see exclusive content. If you have already made the payment, wait for confirmation.</p></div>";
