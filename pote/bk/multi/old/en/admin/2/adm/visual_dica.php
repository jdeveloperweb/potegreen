...
<div class="container theme-showcase" role="main">      
	...
	<div class="row">
		<div class="pull-right">
			...
			<a href='administrativo.php?link=30&id=<?php echo $resultado['id']; ?>'><button type='button' class='btn btn-sm btn-warning'>Editar</button></a>
	...
	<div class="row">
		<div class="col-md-12">
         ...
         <b>Dia:</b>
			...
			<div class=" col-sm-9 col-md-11"><strong>
