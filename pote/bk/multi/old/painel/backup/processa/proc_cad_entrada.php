...
mysql_query("INSERT INTO entradas (id_user, data, hora, tipo, descr, oddini, oddent, valor_ent, status, valor_fim, id_jogsug) values ('$id_user', '$data', '$hora', 'Simples', '$descr', '$oddini', '$oddent', '$valor_ent', '$status', '$valor_fim', '$id_jogsug')");	 

mysql_query("UPDATE user SET bancaatual -'$valor_ent' WHERE id_user = '$id_user'");	 
