...
$data = "$ano-$mes-$dia";
	...
	$hoje= date('d-m-Y');
	$resultado2=mysql_query("SELECT * FROM multiplassug WHERE data >= '$data'");
	$linhas2=mysql_num_rows($resultado2);
	
?>	
<p class="text-muted m-b-30 font-14"> Lista das múltiplas selecionados que ocorrerão a partir de <strong><?php echo date("d")." de ".$meses[date('m')]; ?></strong>. Você pode cadastrar uma entrada para sua gestão de banca caso queira seguir alguma dessas dicas que seguem. Basta clicar em "Cadastrar".</p>
                                            ...
                                            <div class="table-responsive">
												...
												<thead>
                                                    <tr>
                                                        <th>Dia</th>
                                                        <th class="col-sm-3">Jogos</th>
                                                        <th>Odd</th>
                                                        <th>Status</th>                                      
                                                        <th>Entrada na Múltipla</th>
															...
															<td><a href='administrador.php?link=11&tipo=Multipla&id=<?php echo $linhas2['id']; ?>'><button type='button' class='btn btn-success btn-sm waves-effect'><i class="fa fa-check  "></i> Cadastrar</button></a>
																 </tr>
															<?php } elseif ($linhas2['status']=='Em análise') { ?>
																<td><a href='#'><button type='button' class='btn btn-outline-secondary  btn-sm waves-effect' data-toggle="tooltip" data-placement="top" title="Multipla sendo analisada"><i class="fa fa-check  "></i> Cadastrar</button></a>
																 </tr>
															<?php }
															
																		else {	?> 
															<td><a href='#'><button type='button' class='btn btn-outline-secondary  btn-sm waves-effect' data-toggle="tooltip" data-placement="top" title="Multipla já processada"><i class="fa fa-check  "></i> Cadastrar</button></a>
																 </tr>
