...
$data = "$ano-$mes-$dia";
	...
	$hoje= date('d-m-Y');
	$resultado=mysql_query("SELECT * FROM jogosug WHERE data >= '$data'");
...
?>													<h5>Cadastrar múltipla de Odd   <span class="badge badge-pill badge-success">@<span id="TotCubagem"> 0</span></span></h5>
													 ...
													 <div>2º - Clique em "Cadastrar Múltipla" </br></div><hr>
...
</select></div> <div class="form-group col-lg-12"><input type="hidden" name="valor" id="valor"/>
														
      											 </br><p class= "text-align-center"> <button type="submit" class="btn btn-success">Cadastrar Múltipla</button></br></p>
                                           </div> 
                                          </div>
                                     </div>
												<div class="form-group">
...
<?php
	...
	$resultado2=mysql_query("SELECT * FROM multiplassug WHERE status ='Em análise'");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th></th>
															...
															<?php  while($linhas2 = mysql_fetch_array($resultado2)){	
																	echo "<tr>";
																	echo "<td><i class='mdi mdi-checkbox-blank-circle text-blue-grey'></i>".$linhas2['id']."</td>";
																	echo "<td><p class='m-0 text-muted font-14'>".$linhas2['descricao']."</p></td>";
															...
															?>	
																	<td><a href='processa/proc_edit_multipla.php?status=1&id=<?php echo $linhas2['id']; ?>'><button type='button' class='btn btn-success btn-sm waves-effect'>Vencida</button></a>
																	<a href='processa/proc_edit_multipla.php?status=2&id=<?php echo $linhas2['id']; ?><button type='button' class='btn btn-danger btn-sm waves-effect'>Perdida</button></a>
																	<a href='processa/proc_edit_multipla.php?status=3&id=<?php echo $linhas2['id']; ?><button type='button' class='btn btn-primary btn-sm waves-effect'>Aprovada</button></a>
																	<a href='processa/proc_apagar_multipla.php?&id=<?php echo $linhas2['id']; ?><button type='button' class='btn btn-secondary btn-sm waves-effect'>Excluir</button></td></a>
															</tr>
															<?php }?>													
