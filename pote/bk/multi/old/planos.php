...
<!-- End Google Tag Manager (noscript) -->
  <section class="menu cid-s99Ueb1i3l" once="menu" id="menu1-p">
...
<section class="engine"><a href="https://mobirise.info/y">free html web templates</a></section><section class="mbr-section content4 cid-s99UebYACq" id="content4-q">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-2"><strong>Assinar Agora</strong></h3>
...
<section class="pricing-table3 cid-s99Ur1h1Yb" id="pricing-tables3-t">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class=" col-12 col-lg-4 col-md-6 my-2">
                <div class="pricing">
                    <div class="plan-header">Valor mensal:
                    ...
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">Valor cobrado mensalmente. Mesmos benefícios porém sem o desconto nas parcelas.</p>
                          </div>
                </div>
            </div>
                ...
                <div class="pricing">
                    <div class="plan-header">Valor mensal:
                        <div class="plan-price">
                            ...
                            <span class="price-figure mbr-fonts-style display-1">125</span>,00
                            <h3 class="plan-title mbr-fonts-style display-5">
                                PLANO SEMESTRAL</h3>
                            <hr>
                        </div>
                    ...
                    <div class="plan-body">
                        <p class="mbr-text mbr-fonts-style display-7">
                            Pague 5 meses e ganhe R$150 de desconto. De R$900 por R$750.</p>
                        </div>
                </div>
                ...
                <div class="pricing">
                    <div class="plan-header">Valor mensal:
                        <div class="plan-price">
                            ...
                            <h3 class="plan-title mbr-fonts-style display-5">PLANO ANUAL</h3>
                            <hr>
                        </div>
                    </div>
                    <div class="plan-body ">
                        <p class="mbr-text mbr-fonts-style display-7">Pague 8 meses e ganhe R$588 de desconto. De R$1788 por R$1200.</p>
                     </div>
                </div>
            </div>
        </div></br>
		<div class="media-container-row">
            ...
            <div class=" col-12 col-lg-12 col-md-12 my-12">
                <div class="pricing">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-sm-offset-12 col-md-offset-12">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Faça seu cadastro agora mesmo: </h3>
			 			</div>
			 			<div class="panel-body">
			    		<form role="form" method="POST" action="admin/2/adm/processa/proc_cad_assinatura.php">
			    			<div class="row">
			    			...
			    			<div class="form-group">
							<label for="inputPassword3" class="col-sm-6 control-label">Plano escolhido</label>
							<div class="col-sm-6">
							  <select class="form-control" name="plano">
								  <option  value="0">Selecione o Plano</option>
								   <option selected value="1">PLANO MENSAL (R$149)</option>
								  <option value="2">PLANO SEMESTRAL (R$750,00)</option>
								  <option value="3">PLANO ANUAL (R$1200,00)</option>
								</select>
							</div>
						  </div>
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="password" name="senha" id="password_confirmation" class="form-control input-sm" placeholder="Confirme sua senha">
			    					</div>
			    				</div>
			    			</div>
			    			
			    			<input type="submit" id="inputSubmit" value="Ir para pagamento" class="btn btn-danger btn-block">
...
<section once="footers" class="cid-s99UecFQVn" id="footer6-s">
