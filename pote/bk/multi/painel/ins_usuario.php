                        ...
                        <div class="col-lg-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Inserir Usuário</h4>
                                    <p class="text-muted m-b-30 font-14"> </p>

                                    <form class="" method="POST" action="processa/proc_ins_usuario.php">
                                        ...
                                        <div class="form-group">
                                            <label>Plano</label>
                                            <input type="text" class="form-control" name='plano' placeholder="Digite o plano"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select class="form-control" name='status'>
                                                ...
                                                <option value="Reelmbolsado" >Reelmbolsado</option>
                                                <option value="Cancelado" >Cancelado</option></select>
                                        </div>
                                        <div class="form-group">
                                            <label>Senha</label>
                                            <div>
                                                <input type="number" name='senha' id="pass2" class="form-control" required value='123456' />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>E-Mail</label>
                                            <div>
                                                <input type="email" name='email' class="form-control" parsley-type="email"  placeholder="Digite o e-mail @"/>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label>Data</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input data-parsley-type="number" name='telefone' type="text" class="form-control" placeholder="Digite apenas números" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div>
                                                ...
                                                <a href="administrador.php?link=1" class="btn btn-secondary waves-effect" role="button">Cancelar</a>
