                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body"></br></br>
                                            ...
                                            $hoje = date('d-m-Y');
                                            $resultado2 = mysqli_query($conectar, "SELECT * FROM jogosug WHERE data >= '$data' ORDER  BY confianca DESC");
                                            ...
                                            <a href='administrador.php?link=14' target='_blank'><button type='button' class='btn btn-success btn-sm waves-effect'><i class="fa fa-external-link   "></i> Ver múltiplas</button></a></p>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            if ($linhas2['status'] == 'Pendente') { ?>
                                                            	<?php echo "<td><a href=administrador.php?link=23&id=".$linhas2['id'].">";?><button type='button' class='btn btn-primary btn-sm waves-effect'><i class="fa fa-check  "></i> Editar</button></a>
																	<a href='#'><button type='button' class='btn btn-danger btn-sm waves-effect'><i class="fa fa-close  "></i> Excluir</button></a></td>
                                                                ...
                                                                <?php } else {    ?>
                                                                	<?php echo "<td><a href=administrador.php?link=23&id=".$linhas2['id'].">";?><button type='button' class='btn btn-primary btn-sm waves-effect'><i class="fa fa-check  "></i> Editar</button></a>
																	<a href='processa/proc_apagar_jogo.php?id=<?php echo $linhas2['id'];?>'><button type='button' class='btn btn-danger btn-sm waves-effect'><i class="fa fa-close  "></i> Excluir</button></a></td>
