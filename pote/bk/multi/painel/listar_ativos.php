			                ...
			                <div class="container-fluid">
			                    ...
			                    <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $resultado3 = mysqli_query($conectar, "SELECT * FROM user WHERE status='Ativo' ORDER  BY id DESC");
                               ...
                               <tr>
                                    ...
                                    <td>' . $row["status"] . '</td>   
                                    <td>' . $row["plano"] . '</td> 
                                    <td>  <a href=administrador.php?link=25&id='.$row['id'].'><button type="button" class="btn btn-warning btn-sm waves-effect">Editar</button></a> 
                                    <a href=processa/proc_cancelar.php?id='.$row['id'].'><button type="button" class="btn btn-primary btn-sm waves-effect">Cancelar</button></a></td>  
                               </tr>  
                               ';
                                            }
                                            ?>
