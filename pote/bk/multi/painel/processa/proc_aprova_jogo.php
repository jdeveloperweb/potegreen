...
$query = mysqli_query($conectar, "UPDATE jogosug set ap_villa = ap_villa  +'$villa', ap_ganso = ap_ganso  +'$ganso', ap_janjao = ap_janjao  +'$janjao', confianca = confianca +'$atualizaconf' WHERE id='$id'");
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
