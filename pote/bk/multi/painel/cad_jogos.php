										...
										<div class="form-group">
                                            ...
                                            <td><input type="text" class="form-control" maxlength="25"  name="timea[]"  placeholder="TIMEA" id="timeA" /></td>
                                                        ...
                                                        <option >Select</option>
                                                           <option value="Time1 vence">Time1 vence</option>
                                                           <option value="Time1 1T">Time1 1T</option>
                                                            <option value="Time2 vence">Time 2 vence</option>
                                                            ...
                                                            <option value="Time1 hand -1, -1,5">Time1 hand -1, -1,5</option>
                                                            <option value="Time2 hand -1, -1,5">Time2 hand -1, -1,5</option>
                                                        </optgroup>
                                                    </select></td>
