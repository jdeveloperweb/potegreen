...
<div class="card m-b-20">
                                        <div class="card-body"></br></br>
                                            <h4 class="mt-0 m-b-30 header-title">Múltiplas Selecionadas </h4> <p class="text-muted m-b-30 font-14"> Lista das múltiplas que ainda não foram processadas.</p>
...
$data = "$ano-$mes-$dia";
	...
	$hoje= date('d-m-Y');
	$resultado2=mysqli_query($conectar,"SELECT * FROM multiplassug WHERE data >= '$data' OR status =  'Pendente'");
												...
												<thead>
                                                    <tr>
                                                        ...
                                                        <th></th>
															...
															?>
															<td><a href='processa/proc_ins_resultado_multipla.php?tipo=Multipla&status=1&id=<?php echo $linhas2['id']; ?>'><button type='button' class='btn btn-success btn-sm waves-effect'><i class="fa fa-check  "></i> GREEN</button></a>
																	<a href='processa/proc_ins_resultado_multipla.php?tipo=Multipla&status=2&id=<?php echo $linhas2['id']; ?>'><button type='button' class='btn btn-danger btn-sm waves-effect'><i class="fa fa-close  "></i> RED</button></a>
																	<a href='processa/proc_ins_resultado_multipla.php?tipo=Multipla&status=3&id=<?php echo $linhas2['id']; ?>'><button type='button' class='btn btn-primary btn-sm waves-effect'><i class="fa   fa-circle-o  "></i> ANULADO</button></a>
															 </tr>
															 <?php }?>													
